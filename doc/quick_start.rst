...
changes. Replace all occurrences of ``UnexpectedPatternCoocurrence`` and ``unexpected-pattern-coocurrence``
with the name of you own contribution. You can find all the occurrences using
the following command::

    $ git grep UnexpectedPatternCoocurrence
    $ git grep unexpected-pattern-coocurrence
