...
project = u'unexpected-pattern-coocurrence'
...
from UnexpectedPatternCoocurrence import __version__
version = __version__
...
sphinx_gallery_conf = {
    'doc_module': 'UnexpectedPatternCoocurrence',
    'backreferences_dir': os.path.join('generated'),
    'reference_url': {
        'UnexpectedPatternCoocurrence': None}
}
